...
- 🎓 Currently developing my B.Eng. thesis: An IoT-based automated studio "On-Air" lighting control system. It integrates ESP32 hardware with an MQTT broker and a Digital Audio Workstation (Reaper) for seamless hardware-software synchronization.
- 🧠 Intrested in building real-time automated vision systems using **YOLO**, **PyTorch**, and accelerating them with **CUDA C++**.
